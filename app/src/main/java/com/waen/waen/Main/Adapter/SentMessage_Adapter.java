...
public class SentMessage_Adapter extends RecyclerView.Adapter<SentMessage_Adapter.MyViewHolder>{
    ...
    public SentMessage_Adapter(List<Inbox_details> list, Context context){
...
//    }
    @Override
    public SentMessage_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_chat_admin, parent, false);
        return new SentMessage_Adapter.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final SentMessage_Adapter.MyViewHolder holder, final int position) {
