...
public class Inbox_SuperVisor_Admin extends RecyclerView.Adapter<Inbox_SuperVisor_Admin.MyViewHolder>{
    ...
    public Inbox_SuperVisor_Admin(List<Inbox_details> list, Context context){
...
//    }
    @Override
    public Inbox_SuperVisor_Admin.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_chat_admin, parent, false);
        return new Inbox_SuperVisor_Admin.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Inbox_SuperVisor_Admin.MyViewHolder holder, final int position) {
