...
public class Buses_Adapter_supervisor extends RecyclerView.Adapter<Buses_Adapter_supervisor.MyViewHolder>{
...
//    }
    @Override
    public Buses_Adapter_supervisor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_buses_supervisor, parent, false);
        return new Buses_Adapter_supervisor.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Buses_Adapter_supervisor.MyViewHolder holder, final int position) {
