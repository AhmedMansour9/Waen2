...
public class Super_Visors_Adapter_supervisor extends RecyclerView.Adapter<Super_Visors_Adapter_supervisor.MyViewHolder>{
...
//    }
    @Override
    public Super_Visors_Adapter_supervisor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_buses_supervisor, parent, false);
        return new Super_Visors_Adapter_supervisor.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Super_Visors_Adapter_supervisor.MyViewHolder holder, final int position) {
