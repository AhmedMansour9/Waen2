...
public class Requests_Adapter_Admin extends RecyclerView.Adapter<Requests_Adapter_Admin.MyViewHolder>{
...
//    }
    @Override
    public Requests_Adapter_Admin.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_notification_admin, parent, false);
        return new Requests_Adapter_Admin.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Requests_Adapter_Admin.MyViewHolder holder, final int position) {
