...
public class Sent_Parent_Admin extends RecyclerView.Adapter<Sent_Parent_Admin.MyViewHolder>{
    ...
    public Sent_Parent_Admin(List<Inbox_details> list, Context context){
...
//    }
    @Override
    public Sent_Parent_Admin.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_chat_admin, parent, false);
        return new Sent_Parent_Admin.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Sent_Parent_Admin.MyViewHolder holder, final int position) {
