...
public class Notification_Adapter_admin extends RecyclerView.Adapter<Notification_Adapter_admin.MyViewHolder>{
...
//    }
    @Override
    public Notification_Adapter_admin.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_notification_admin, parent, false);
        return new Notification_Adapter_admin.MyViewHolder(itemView);
    }
    @Override
    public void onBindViewHolder(final Notification_Adapter_admin.MyViewHolder holder, final int position) {
