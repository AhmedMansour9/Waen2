...
import com.waen.waen.Admin.Adapter.Sent_Parent_Admin;
import com.waen.waen.Admin.Adapter.Sent_SuperVisor_Admin;
 ...
 */
public class Sent_SuperVisor extends Fragment implements Messages_Inbox_View,SwipeRefreshLayout.OnRefreshListener{


    public Sent_SuperVisor() {
        // Required empty public constructor
    }
    View view;
    RecyclerView recyclerNotification;
    Sent_Parent_Admin super_visors_adapter_admin;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_sent__super_visor, container, false);
    ...
    private void Recyclview() {
        recyclerNotification=view.findViewById(R.id.recycler_send);
        recyclerNotification.setHasFixedSize(true);

    }

    public void SwipRefresh(){
        mSwipeRefreshLayout =  view.findViewById(R.id.swipe_send);
        ...
        mSwipeRefreshLayout.post(new Runnable() {
            ...
            public void run() {
                if (networikConntection.isNetworkAvailable(getContext())) {
                    ...
                    message_Inbox_Presenter.Sent_SuperVisor_Admin(User_Token,"supervisor");
                } else {
    ...
    public void Sent_SuperVisor_Admin(List<Inbox_details> inbox_details) {
        super_visors_adapter_admin = new Sent_Parent_Admin(inbox_details, getContext());
