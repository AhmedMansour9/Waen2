 ...
 */
public class Sent_Parent extends Fragment implements Messages_Inbox_View,SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_sent__parent, container, false);
        ...
        mSwipeRefreshLayout.post(new Runnable() {
            ...
            public void run() {
                if (networikConntection.isNetworkAvailable(getContext())) {
                    ...
                    message_Inbox_Presenter.Sent_Parent_Admin(User_Token,"parent");
