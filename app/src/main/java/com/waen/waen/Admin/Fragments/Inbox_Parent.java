...
import com.waen.waen.Main.Adapter.Inbox_Parent_Admin;
 ...
 */
public class Inbox_Parent extends Fragment implements Messages_Inbox_View,SwipeRefreshLayout.OnRefreshListener{
    ...
    Inbox_Parent_Admin super_visors_adapter_admin;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_inbox__parent, container, false);
        ...
        mSwipeRefreshLayout.post(new Runnable() {
            ...
            public void run() {
                    if (networikConntection.isNetworkAvailable(getContext())) {
                        ...
                        message_Inbox_Presenter.Inbox_Parent_Admin(User_Token,"parent");
    ...
    public void Inbox_Parent_Admin(List<Inbox_details> inbox_details) {
        ...
        super_visors_adapter_admin = new Inbox_Parent_Admin(inbox_details, getContext());
